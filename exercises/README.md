...
| 4 | [File systems](04-fs.md) | fs syscalls, SFS directories, locking, buffer cache, journaling + crash recovery | largest |
...
- Harvard CS161 2017: <https://www.eecs.harvard.edu/~cs161/> —
  assignment pages at `assignments/a1.html` … `a4.html` (a4 is the
  only public spec for the file system exercise; ops-class stops at 3)
...
main                    # patched baseline; the ASST1 starting point
  ...
  asst4/<attempt>       # branch from an accepted asst3 result
```
